...
function Contact ()
{
    const contacts = [
        {
            ...
            website: "martin-kagya-agyemang@linkedin",
            id: "linkedin"
        },
        {
            name: "twitter",
    ...
    return(
        <>
            <div className='height flex flex-col whitespace-nowrap lg:text-lg md:text-base'>
                ...
                <div><span className='p-5 text-zinc-500'>2</span><span><span className='text-slate-300'>{`{`}</span></span>
                    {
                        ...
                        (
                            <p className='' key={contact.id}><span className='p-5 text-zinc-500'>{index + 3}</span><span className='pl-8 text-sky-500'>{contact.name}<span className='text-slate-300'>: </span> 
                            <a href={contact.Link}><span className='text-orange-300'>{contact.website}</span></a>
